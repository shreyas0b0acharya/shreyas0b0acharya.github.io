...
export const About = () => {
  return (
    <div className="bg-gray-100 dark:bg-black min-h-screen py-10 px-5">
      ...
      <h1 className="text-3xl md:text-4xl font-bold mb-6 text-center text-themeColor">About This Application</h1>
  ...
  <p className="text-gray-700 dark:text-gray-200 text-lg leading-relaxed mb-6">
    ...
    It’s designed to be responsive, easy to use, and helpful for both students and faculty.
        ...
        <div className="text-center mb-8">
          ...
          <p className=" dark:text-gray-200 text-sm text-gray-500">USN: 4SM23CS088 | CSE | 2nd Year, 4th Semester | SJMIT, Chitradurga</p>
          <p className=" dark:text-gray-200 text-sm text-gray-500">Email: <a href="mailto:shreyasb19386@gmail.com" className="text-blue-500">shreyasb19386@gmail.com</a></p>
        </div>
        ...
        <div className="grid grid-cols-3 sm:grid-cols-4 gap-4 text-center">
          {/* Add logos of each technology with link */}
          ...
          {/* <a href="https://axios-http.com/" target="_blank" rel="noopener noreferrer">
            <img src="https://axios-http.com/favicon.ico" alt="Axios" className="w-16 mx-auto" />
            <p className="text-sm text-gray-600 mt-2">Axios</p>
          </a> */}
        </div>
        ...
        <div className="mt-8">
          ...
          <p className=" dark:text-gray-200 text-gray-600">Feel free to get in touch for any inquiries or contributions!</p>
          <p className=" dark:text-gray-200 text-sm text-gray-500 mt-2">Email: <a href="mailto:shreyasb19386@gmail.com" className="text-blue-500">shreyasb19386@gmail.com</a></p>
        </div>
      </Card>
      <Footer></Footer>
    </div>
